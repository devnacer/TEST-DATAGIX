  ...
  <div class="main-container d-flex">
    ...
    <div class="content">
      ...
      <div class="dashboard-content px-3 pt-4">
        ...
        <!--____________table1______________ -->
        <div class="container" id="tab1">

          <div class="fs-5 text-center">
            <h2>Téléphone sonne
 <span id="nbCalls_table1" class="badge bg-primary"></span></h2>
          </div>
        ...
        <div class="container" id="tab2">
          ...
          <div class="fs-5 text-center">
            <h2>Appels entrants en cours <span id="nbCalls_table2" class="badge bg-primary"></span></h2>
          </div>
        ...
        <div class="container" id="tab3">
          <div class="fs-5 text-center">
            <h2>Nombre d’appel décroché en cours <span id="nbCalls_table3" class="badge bg-primary"></span></h2>
          </div>
        ...
        <!--___________table4________________ -->
        <div class="container" id="tab1">
          <div class="fs-5 text-center">
            <h2>Appels entrants non décrochés <span id="nbCalls_table4" class="badge bg-primary"></span></h2>
          </div>
